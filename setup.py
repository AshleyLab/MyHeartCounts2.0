...
setuptools.setup(
    ...
    zip_safe=True,
    license="",
    download_url = "https://github.com/AshleyLab/MyHeartCounts2.0/archive/refs/tags/v0.0.14.tar.gz",
    url="https://github.com/AshleyLab/MyHeartCounts2.0",
    install_requires=['numpy','synapseclient','datetime','pandas','csv','json']
)
